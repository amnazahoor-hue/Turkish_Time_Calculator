...
export function HeroHourlyWageVisual() {
  return (
    <div
    ...
    >
      ...
      >
        ...
        >
          <Image
            src="/images/hero-hourly-wage-visual.webp"
            alt="Saat ücreti hesaplama — maaş ve saatlik ücret illüstrasyonu"
            title="Saat ücreti hesaplama — maaş ve saatlik ücret illüstrasyonu"
            width={900}
            height={900}
            priority
            className="h-full w-full !ml-0 [object-fit:contain] drop-shadow-[0_28px_56px_rgba(0,43,91,0.28)]"
          />
        </motion.div>
      </motion.div>
